const NAV = [
  ...
  {href:'15-exercise-kanban.html',num:'E1',label:'Exercise 1 · Task Sprint',time:'20m'},
  {href:'10a-agents-working.html',num:'11A',label:'Agents Working',time:'8m'},
  ...
  {href:'13-dashboard-mcp.html',num:'14',label:'MCP',time:'8m'},
  {href:'14-agent-chaining.html',num:'15',label:'Agent Chaining & Handoffs',time:'12m'},
  {href:'16-exercise-conductor.html',num:'E2',label:'Exercise 2 · Mission to Board',time:'20m'},
  {href:'17-exercise-pipeline.html',num:'E3',label:'Exercise 3 · Full Pipeline',time:'25m'},
